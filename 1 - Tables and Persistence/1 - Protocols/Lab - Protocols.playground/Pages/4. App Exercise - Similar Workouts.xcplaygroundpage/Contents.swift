...
let running1 = RunningWorkout(distance: 4.0, time: 4.0)
let swimming1 = SwimmingWorkout(distance: 5.0, time: 5.0)

simpleWorkoutDescription(workout: running1)
simpleWorkoutDescription(workout: swimming1)
/*:
